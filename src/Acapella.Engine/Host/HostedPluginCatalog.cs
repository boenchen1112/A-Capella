...
/// location confirmed present on this machine (see CLAUDE.md's Environment section).
/// </summary>
public static class HostedPluginCatalog
{
    ...
    {
        ["FabFilter Pro-Q 4"] = $@"{Vst3Root}\FabFilter Pro-Q 4.vst3",
        ["FabFilter Pro-C 3"] = $@"{Vst3Root}\FabFilter Pro-C 3.vst3",
        ["FabFilter Pro-L 2"] = $@"{Vst3Root}\FabFilter Pro-L 2.vst3",
        ["FabFilter Pro-G"] = $@"{Vst3Root}\FabFilter Pro-G.vst3",
        ["FabFilter Pro-R 2"] = $@"{Vst3Root}\FabFilter Pro-R 2.vst3",
